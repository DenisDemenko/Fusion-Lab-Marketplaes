...
## Фаза 2 — Глибина маркетплейсу 🚧 6/7 готово 2026-08-29, i18n ще ні
...
- [ ] i18n UA/EN через `next-intl`, `[locale]/`-роутинг — **відкладено**,
      велика механічна робота (переструктурування роутингу під
      `[locale]/`, винесення рядків із 27 сторінок у файли перекладу),
      відмінна за характером від решти Фази 2 (доменне моделювання).
      Рішення: зробити окремим проходом, коли інша Фаза 2 стабілізується
